...
const EmailSender = ({fullName,email,phone,message}) => {
    const options = {
        ...
        subject: "Message From Gallops System And Solutions",
        html:`<div style="width: 100%; background-color: #f3f9ff; padding: 5rem 0">
        <div style="max-width: 700px; background-color: white; margin: 0 auto">
          <div style="width: 100%; background-image: linear-gradient(to right, #FFAC1C ,#4B0082); padding: 20px 0">
          ...
          <div style="width: 100%; gap: 10px; padding: 30px 0; display: grid">
            <p style="font-weight: 800; font-size: 1.2rem; padding: 0 30px">
              From Gallops System and Solutions
            </p>
